"""
Даша Partners — affiliate program integration (sochiautoparts.ru/partners.json).
...
logger = logging.getLogger("dasha.partners")
    ...
    async def load(self):
        ...
        try:
            async with httpx.AsyncClient(timeout=15.0, follow_redirects=True) as c:
                resp = await c.get(config.PARTNERS_URL, headers={"User-Agent": "DashaBot/1.0"})
