...
_HELP_TEXT = (
    ...
    "/compare — сравнение материалов: ЛДСП, МДФ, массив ⚖️\n"
    "/mistakes — 5 ошибок при заказе мебели ⚠️\n"
    "/sizes — стандартные размеры и эргономика 📏\n"
    "/gallery — галерея стилей с примерами 🎨\n"
